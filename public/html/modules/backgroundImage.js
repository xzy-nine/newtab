  ...
  async setImage() {
    return this.queueTask(async () => {
      try {
        ...
        switch (this.settings.type) {
          case "custom":
            ...
            if (this.settings.customImageData) {
              ...
              Notification.updateLoadingProgress(
                60,
                I18n.getMessage("loadingCustomBackground", "加载自定义背景"),
              );
            } else {
              // 如果没有自定义图片数据，则回退到必应
          ...
          default:
            ...
            Notification.updateLoadingProgress(
              100,
              I18n.getMessage("backgroundLoadComplete", "背景加载完成"),
            );
        ...
        Notification.updateLoadingProgress(
          70,
          I18n.getMessage("preloadingBackground", "预加载背景图片"),
        );
