...
export const NotificationManager = {
    ...
    return [
      {
        ...
        description: I18n.getMessage(
          "settingsNotificationDurationInfoDesc",
          "信息类通知的显示时间",
        ),
        testButton: true,
        resetButton: true,
        ...
        testType: "info",
        onChange: (value) => {
          this.handleNotificationDurationChange(
            "notification-duration-info",
      ...
      },
      {
        ...
        unit: I18n.getMessage("seconds", "秒"),
        description: I18n.getMessage(
          "settingsNotificationDurationSuccessDesc",
          "成功类通知的显示时间",
        ),
        testButton: true,
        resetButton: true,
      ...
      },
      {
        ...
        unit: I18n.getMessage("seconds", "秒"),
        description: I18n.getMessage(
          "settingsNotificationDurationWarningDesc",
          "警告类通知的显示时间",
        ),
        testButton: true,
        resetButton: true,
      ...
      },
      {
        ...
        unit: I18n.getMessage("seconds", "秒"),
        description: I18n.getMessage(
          "settingsNotificationDurationErrorDesc",
          "错误类通知的显示时间（固定配置）",
        ),
        testButton: true,
        resetButton: true,
      ...
      // 外部通知开关
      {
        ...
        description: I18n.getMessage(
          "externalNotificationsEnabledDesc",
          "允许其他网页和油猴脚本使用扩展的通知功能",
        ),
        onChange: (value) => {
          ...
          if (value) {
            Notification.notify({
              ...
              message: I18n.getMessage(
                "externalNotificationsApiEnabledDesc",
                "其他网页现在可以使用扩展的通知功能",
              ),
              type: "success",
              duration: 3000,
      ...
      // 外部通知统计信息
      {
        ...
        type: "custom",
        description: I18n.getMessage(
          "externalNotificationsStatsDesc",
          "查看和管理外部通知请求的统计信息",
        ),
        render: (container) => {
  ...
  createTestButton(type) {
    const testBtn = Utils.createElement(
      "button",
      "btn btn-small btn-info test-notification-btn",
      {
        type: "button",
        "data-test-type": type,
      },
  ...
  createResetButton(settingId, defaultValue) {
    const resetBtn = Utils.createElement(
      "button",
      "btn btn-small btn-secondary reset-default-btn",
      {
        type: "button",
      },
    ...
    try {
      ...
      if (stats.recentRequests.length > 0) {
        ...
        recentList.style.cssText =
          "max-height: 200px; overflow-y: auto; border: 1px solid #dee2e6; border-radius: 4px;";
