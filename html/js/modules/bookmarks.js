...
// =====================================================
// 以下是保留的向后兼容函数，标记为弃用状态
// =====================================================

/**
 * 初始化书签功能
 * @returns {Promise<void>}
 * @deprecated 请使用 BookmarkManager.init() 代替
 */
export async function initBookmarks() {
    console.warn('函数 initBookmarks 已弃用，请使用 BookmarkManager.init() 代替');
    return await BookmarkManager.init();
}

/**
 * 获取所有书签
 * @returns {Array} - 书签数组
 * @deprecated 请使用 BookmarkManager.getAllBookmarks() 代替
 */
export function getAllBookmarks() {
    console.warn('函数 getAllBookmarks 已弃用，请使用 BookmarkManager.getAllBookmarks() 代替');
 ...
 * @param {Array} importedBookmarks - 要导入的书签数组
 * @returns {Promise<void>}
 * @deprecated 请使用 BookmarkManager.importBookmarks() 代替
 */
export async function importBookmarks(importedBookmarks) {
    console.warn('函数 importBookmarks 已弃用，请使用 BookmarkManager.importBookmarks() 代替');
    return await BookmarkManager.importBookmarks(importedBookmarks);
}

/**
 * 导出书签
 * @returns {Object} - 包含书签数组的对象
 * @deprecated 请使用 BookmarkManager.exportBookmarks() 代替
 */
export function exportBookmarks() {
    console.warn('函数 exportBookmarks 已弃用，请使用 BookmarkManager.exportBookmarks() 代替');
    return BookmarkManager.exportBookmarks();
}

/**
 * 设置书签事件
 * @deprecated 请使用 BookmarkManager.initEvents() 代替
 */
export function setupBookmarkEvents() {
    console.warn('函数 setupBookmarkEvents 已弃用，请使用 BookmarkManager.initEvents() 代替');
